...
describe('OrdersController (Integration)', () => {
  ...
  beforeEach(async () => {
    ...
    ordersService = moduleFixture.get<OrderService>(OrderService)
  ...
  describe('GET /orders/:id', () => {
    ...
    it('should return 500 if order not found', async () => {
      ...
      await supertest(app.getHttpServer()).get('/orders/999').expect(500)
  ...
  describe('DELETE /orders/:id', () => {
    it('should delete an order', async () => {
      ...
      await supertest(app.getHttpServer()).delete('/orders/1').expect(200)
    ...
    it('should return 500 if order not found for deletion', async () => {
      ...
      await supertest(app.getHttpServer()).delete('/orders/999').expect(500)
